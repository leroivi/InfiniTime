...
static void basic_init() {
  ...
  lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, Colors::Black);
  ...
  lv_style_set_text_color(&style_label_white, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_text_color(&style_label_white, LV_STATE_DISABLED, Colors::Gray);

  style_init_reset(&style_btn);
  lv_style_set_radius(&style_btn, LV_STATE_DEFAULT, 10);
  lv_style_set_bg_opa(&style_btn, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);
  ...
  lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_text_color(&style_btn, LV_STATE_DISABLED, Colors::Gray);
  ...
  lv_style_set_text_color(&style_icon, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_bg_color(&style_list_btn, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);
  lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, Colors::White);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED, Colors::White);
  ...
  lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);

  style_init_reset(&style_sw_bg);
  lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);
  ...
  lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::highlight);

  style_init_reset(&style_sw_knob);
  lv_style_set_bg_opa(&style_sw_knob, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, Colors::Silver);
  lv_style_set_bg_color(&style_sw_knob, LV_STATE_CHECKED, Colors::White);
  ...
  lv_style_set_bg_color(&style_slider_knob, LV_STATE_DEFAULT, Colors::Red);
  lv_style_set_border_color(&style_slider_knob, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_line_color(&style_arc_bg, LV_STATE_DEFAULT, InfiniTimeTheme::Colors::bg);
  ...
  lv_style_set_bg_color(&style_arc_knob, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_pad_all(&style_arc_knob, LV_STATE_DEFAULT, LV_DPX(5));

  style_init_reset(&style_table_cell);
  lv_style_set_border_color(&style_table_cell, LV_STATE_DEFAULT, Colors::Gray);
  ...
  lv_style_set_line_color(&style_lmeter, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_scale_grad_color(&style_lmeter, LV_STATE_DEFAULT, Colors::White);
  lv_style_set_scale_end_color(&style_lmeter, LV_STATE_DEFAULT, Colors::Gray);
  ...
  lv_style_set_line_color(&style_chart_serie, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_pattern_recolor(&style_cb_bullet, LV_STATE_CHECKED, Colors::White);
...
lv_theme_t* lv_pinetime_theme_init() {
  theme.color_primary = Colors::White;
  theme.color_secondary = Colors::Gray;
