...
WatchFaceAnalog::WatchFaceAnalog(Controllers::DateTime& dateTimeController,
  ...
  lv_obj_set_style_local_scale_end_color(minor_scales, LV_LINEMETER_PART_MAIN, LV_STATE_DEFAULT, Colors::Gray);
  ...
  lv_obj_set_style_local_scale_end_color(major_scales, LV_LINEMETER_PART_MAIN, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_obj_set_style_local_scale_end_color(large_scales, LV_LINEMETER_PART_MAIN, LV_STATE_DEFAULT, Colors::Aqua);
  ...
  lv_obj_set_style_local_text_color(twelve, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::Aqua);
  ...
  lv_obj_set_style_local_text_color(notificationIcon, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::Lime);
  ...
  lv_style_set_line_color(&second_line_style, LV_STATE_DEFAULT, Colors::Red);
  ...
  lv_style_set_line_color(&minute_line_style, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_line_color(&minute_line_style_trace, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_line_color(&hour_line_style, LV_STATE_DEFAULT, Colors::White);
  ...
  lv_style_set_line_color(&hour_line_style_trace, LV_STATE_DEFAULT, Colors::White);
