...
void BatteryIcon::Create(lv_obj_t* parent) {
  ...
  lv_obj_set_style_local_image_recolor(batteryImg, LV_IMG_PART_MAIN, LV_STATE_DEFAULT, Colors::Color(Colors::Black));
...
void BatteryIcon::SetColor(Colors::Color color) {
